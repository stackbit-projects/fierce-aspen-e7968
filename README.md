...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/604e79688ac35c0016af7a45
...
To start editing your site, you can use the Sanity interface at https://fierce-aspen-e7968.sanity.studio/.
...
Generated at `2021-03-14T21:27:01.413Z` by Stackbit version `0.3.50`.